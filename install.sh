...
_select_os_type()
{
    ...
    case $os in
        ...
        CentOS6 )
            os_type='rpm_old'
        ;;
        CentOS[7-8]|AlmaLinux[8-9]|AlmaLinux10|Rocky[8-9]|Rocky10 )
            os_type='rpm_new'
        ;;
        * )
...
_restart_smartd()
{
    ...
    case $os in
        # systemctl on new OS
        Debian[8-9]|Debian1[0-3]|CentOS[7-8]|AlmaLinux[8-9]|AlmaLinux10|Rocky[8-9]|Rocky10|Ubuntu1[6789]|Ubuntu2[0-6] )
...
_enable_smartd_autostart()
{
    ...
    case $os in
        # systemctl on new OS
        Debian[8-9]|Debian1[0-3]|CentOS[7-8]|AlmaLinux[8-9]|AlmaLinux10|Rocky[8-9]|Rocky10|Ubuntu1[6789]|Ubuntu2[0-2] )
